---
layout: post
title: ZoIP - Blast from the past - 10 Year Old Code Challenge
---

# 10 Year Old Code Challenge #
...
**Note:** *I have no connections with Simon, but if he's reading this, this project was pretty slick, great work! Hope you don't mind that I dug this back up and posted it. Would love to know what came of you! 
...
The first issue about the old version that the game used was it's using pipes "|" which were changed to just commas "," so we have to fix this here.
...
As you watch the asterisk console dial 300 on one of your phonesets. You should be greeted by ZORK "You are standing in an open field west of a white house, with a boarded front door..." Good luck, don't get eaten by a grew.
